...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 flex items-center justify-center text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        ...
        >
          Achieve Band 8+ 
          <span className="block bg-gradient-to-r from-cyan-300 via-white to-cyan-300 bg-clip-text text-transparent">in IELTS</span>
        </motion.h1>
        ...
        >
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white text-indigo-600 px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
          >
            Start Your Journey
          </motion.button>
          ...
          <motion.button 
            whileHover={{ scale: 1.05 }} 
            whileTap={{ scale: 0.95 }}
            className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-indigo-600 transition-all duration-300 w-full sm:w-auto"
          >
            Take Free Test
          </motion.button>
        </motion.div>
        ...
        >
          ...
          <div className="bg-white/20 backdrop-blur-md px-6 py-3 rounded-full flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full flex items-center justify-center shadow-lg">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
